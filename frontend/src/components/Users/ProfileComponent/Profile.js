                      ...
                      <div className="flex justify-center place-items-start flex-wrap  md:mb-0">
                        ...
                        <div className="w-full md:w-2/3 px-4 mb-4 md:mb-0">
                          ...
                          {profile?.posts?.length <= 0 ?
                            ...
                            >No post found!</h1> : profile?.posts.map(post => (
                              <div className="flex flex-wrap  -mx-3 mt-3  lg:mb-6">
                                ...
                                <div className="w-full lg:w-3/4 px-3">
                                  ...
                                  >
                                    <h3 className="mb-1 text-2xl text-black font-bold font-heading">
                                      {(post?.title)}
                                    </h3>
                                  </Link>
                                  <p className="text-gray-600 truncate" dangerouslySetInnerHTML={{
